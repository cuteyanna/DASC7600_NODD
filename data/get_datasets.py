...
from data.coco import get_coco_datasets
from data.coco_pas import get_cocopas_datasets
from data.cocotrue import get_cocotrue_datasets
...
from data.coco import subsample_classes as subsample_dataset_coco
from data.coco_pas import subsample_classes as subsample_dataset_cocopas
from data.cocotrue import subsample_classes as subsample_dataset_cocotrue
...
sub_sample_class_funcs = {
    ...
    'coco': subsample_dataset_coco,
    'cocopas': subsample_dataset_cocopas,
    'cocotrue': subsample_dataset_cocotrue
}
...
get_dataset_funcs = {
    ...
    'coco': get_coco_datasets,
    'cocopas': get_cocopas_datasets,
    'cocotrue': get_cocotrue_datasets
}
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    if dataset_name != 'coco' and dataset_name != 'cocopas':
...
def get_class_splits(args):
    ...
    if args.dataset_name == 'cifar10':
        ...
        args.image_size = 150
        args.all_classes = range(21)

    elif args.dataset_name == 'cocotrue':
        args.image_size = 150
        args.train_classes = range(20)
        args.unlabeled_classes = range(20, 80)
